...
function loadSong(song) {
  ...
  /*let filename = `music/${song}.aac`;
  audio.src = `{{ url_for('static', filename=${filename}) }}`;
  console.log(filename);
  filename = `images/${song}.jpg`;
  cover.src = `{{ url_for('static', filename=${filename}) }}`;
  console.log(filename);*/
  audio.src = `static/music/${song}.aac`;
